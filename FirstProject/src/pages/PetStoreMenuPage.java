...
public class PetStoreMenuPage {
	...
	public WebElement getLogInBtn() {
		return this.driver.findElement(By.xpath(locators.getProperty("menu_page_sign_in")));
	}
	...
	public WebElement getCartBtn() {
		return this.driver.findElement(By.xpath(locators.getProperty("menu_page_cart")));
	}
	...
	public WebElement getHelpBtn() {
		return this.driver.findElement(By.xpath(locators.getProperty("petstore_help_page")));
	}
